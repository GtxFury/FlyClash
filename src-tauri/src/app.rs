...
use crate::core::{
    config as core_config, controller as core_controller, lifecycle as core_lifecycle,
    manager::RunningMode, service as core_service,
};
...
use crate::profiles::{
    allowed_subscription_ua_key, config_content, emit_active_config_changed,
    ensure_minimal_mihomo_config, normalize_config_reference, read_last_config, read_subscriptions,
    save_config_content, save_last_config,
};
use crate::resources::{mihomo_dir, sync_bundled_mihomo_data};
use crate::runtime::{
    active_runtime_controller_endpoint, is_mihomo_running, set_runtime_running_mode,
    sync_core_running_state, sync_mihomo_plugin_endpoint,
};
